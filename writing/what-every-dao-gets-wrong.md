...
Arbitrum DAO is suffering from a governance process which is costing us efficiency and accountability. Most DAOs are having this same problem. They suffer from the

[well known pattern](https://forum.arbitrum.foundation/t/grants-funding-framework-discussion-how-to-excel-at-being-a-dao/13818)

of being decentralized and funding too many disjointed efforts causing them to over-correct into centralization. Then, the calls for accountability - which started during the decentralized funding without strategy era - end up driving the further centralization of the DAO by the entities built to steward “progressive decentralization”.
...
](https://pbs.twimg.com/media/Gdb7rziXYAE4Ym-.jpg)
...
1. Optimizing for revenue because we don’t understand how autonomy vs mandates affects the system as a whole - we forgot why decentralization and autonomy are critical.
    
2. Not defining our product as the collaborative goal of the network with a positive feedback loop between our core product success and the price of the governance token
    
3. Settling for a governance process which only emphasizes decision making while completely forgetting about sense making before and action taking after the decision.
...
[here](https://medium.com/@DisruptionJoe/optimizing-supply-chains-with-blockchain-a63dece2f2ca)
...
Before bitcoin, the way transactions were ordered for value exchange was generally done by an exchange. This caused the real estate closest to the NYSE to become incredibly expensive. Not because of the scarcity of the land for any other reason than its signals would get to the stock exchange faster allowing the ability to front run trades from further away. Read all about it in Michael Lewis’
...
1. Play the game as intended creating an economies of scale benefit for all participants including themselves. In game theory this choice is called “collaborate”.
    
2. Play the game in an unexpected way in an attempt to capture more value than is their rightful portion of the increasing returns generated by the other collaborators.
...
](https://pbs.twimg.com/media/Gdb8CmNXUAAkB_n.jpg)
...
Should the city optimize for revenue? Fuck no. It should optimize for more users moving to the city. Not by paying for their first month rent and watching them move out of the city after the program ends (STIP, STIPB, LTIPP), but by supporting the things that make a uniquely enjoyable experience living in Arbitrum City.